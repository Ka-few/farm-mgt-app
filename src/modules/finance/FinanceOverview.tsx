            ...
            <div className="stats-grid" style={{ marginBottom: '2.5rem' }}>
                <div className="stat-card glass">
                    ...
                    <div className="stat-body">
                        <span className="stat-value" style={{ color: 'var(--accent-primary)' }}>KES {summary.income.toFixed(2)}</span>
                ...
                <div className="stat-card glass">
                    ...
                    <div className="stat-body">
                        <span className="stat-value" style={{ color: 'var(--accent-danger)' }}>KES {summary.expenses.toFixed(2)}</span>
                ...
                <div className="stat-card glass">
                    ...
                    <div className="stat-body">
                        <span className="stat-value">KES {summary.balance.toFixed(2)}</span>
                            ...
                            transactions.map((tx) => (
                                <tr key={tx.id}>
                                    ...
                                    <td style={{ fontWeight: 700, color: tx.record_type === 'income' ? 'var(--accent-primary)' : 'var(--text-primary)' }}>
                                        {tx.record_type === 'income' ? '+' : '-'}KES {tx.amount.toFixed(2)}
                                    </td>
                                    <td>
