...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_journal_entry_lines,
            commands::add_journal_entry,
            commands::delete_journal_entry,
            commands::get_general_ledger,
            commands::get_balance_sheet_from_ledger,
            commands::get_profit_loss_from_ledger,
            commands::sync_finance_records_to_ledger,
            commands::populate_accounting_engine,
